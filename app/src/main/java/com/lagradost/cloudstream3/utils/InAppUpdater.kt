...
object InAppUpdater {
    private const val GITHUB_USER_NAME = "refirestream"
    private const val GITHUB_REPO = "FireStream"

    private const val PRERELEASE_PACKAGE_NAME = "com.re.firestream.alpha"
